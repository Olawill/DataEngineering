...
2. You will get a deploy key, head to your GH repo and go to the settings tab. Under security you'll find the menu _deploy keys_. Click on add key and paste the deploy key provided by dbt cloud. Make sure to tick on "write access"
